...
export const generalFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'eBay UK eliminated final value fees for private individual non-business sellers across most consumer categories. However, registered Business Sellers continue to pay standard category commercial rates (11.9% to 14.9% + £0.30 + VAT). You can toggle between private and business modes in Seller Margin Calculator.',
  },
  {
    id: 'faq-6',
